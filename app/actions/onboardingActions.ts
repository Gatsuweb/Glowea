...
export async function getTenantOnboardingState(knownTenantId?: string): Promise<OnboardingState> {
  ...
  const steps: OnboardingStep[] = [
    ...
    {
      id: "firstService",
      title: "Ajouter une premiere prestation",
      description: "Creez votre premiere prestation visible a la reservation.",
      href: "/dashboard/page-publique?tab=prestations",
      completed: firstServiceCompleted,
    },
    {
      id: "firstAppointment",
      title: "Creer mon premier rendez-vous",
      description: "Ajoutez un rendez-vous pour commencer a piloter votre planning.",
