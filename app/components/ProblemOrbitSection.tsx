...
const problemCards: ProblemCard[] = [
  {
    ...
    detail: "Calendrier à surveiller",
    depth: 1.2,
    duration: 6.1,
    orbitX: -28,
    orbitY: -18,
  ...
  //   detail: "aperçu de votre entreprise",
  //   depth: 1,
  //   duration: 8.4,
  //   orbitX: 24,
  //   orbitY: -16,
    ...
    <section className={styles.problemSection} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
      ...
      <div className={styles.problemOrbitScene} ref={sectionRef}>
        <div className={styles.problemCenter}>
          ...
          <h2>Quand tout est éparpillé, chaque journée vous en demande plus.</h2>
          <p>
